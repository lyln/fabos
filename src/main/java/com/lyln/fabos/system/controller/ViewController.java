...
import com.lyln.fabos.common.authentication.ShiroHelper;
import com.lyln.fabos.common.controller.BaseController;
import com.lyln.fabos.common.entity.FebsConstant;
import com.lyln.fabos.common.utils.DateUtil;
import com.lyln.fabos.common.utils.FebsUtil;
import com.lyln.fabos.system.entity.User;
import com.lyln.fabos.system.service.IUserDataPermissionService;
...
public class ViewController extends BaseController {
    ...
    public String index(Model model) {
        ...
        System.out.println("currentUserDetail user:" + user.getUsername());
        currentUserDetail.setPassword("It's a secret");
        model.addAttribute("user", currentUserDetail);
        System.out.println("currentUserDetail mode:" + currentUserDetail.toString());
